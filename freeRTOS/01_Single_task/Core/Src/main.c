...
void OnBoardLED_blink(void *argument);
...
int main(void)
{
  ...
  MX_GPIO_Init();
  /* USER CODE BEGIN 2 */
  osThreadNew(OnBoardLED_blink, NULL, &ledblink_attributes);
  /* USER CODE END 2 */
...
/* USER CODE BEGIN Header_OnBoardLED_blink */
/**
  * @brief  Function implementing the ledblink thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_OnBoardLED_blink */
void OnBoardLED_blink(void *argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
